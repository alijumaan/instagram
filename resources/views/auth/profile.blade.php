...
@section('content')
    ...
    <div class="py-5 text-center">
        <h2 class="mb-3 center">{{ __('frontend.Personal Information') }}</h2>
    </div>
    <div class="row">
        ...
        <div class="col-md-8">
            <form method="post" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="last_name">{{ __('frontend.Last Name') }}</label>
                        <input type="text" id="last_name" placeholder="" value="{{$user->last_name}}" class="form-control @error('last_name') is-invalid @enderror" name="last_name" autofocus>
                        @error('last_name')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <label for="birth_date">{{ __('frontend.Birth Date') }}</label>
                        <input id="datepicker" width="100%" value="{{$user->birth_date}}" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" autofocus/>
                        @error('birth_date')
                        <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-6">
                        ...
                        <input type="file" id="filename" name="avatar" class="form-control @error('filename') is-invalid @enderror">
                        @error('filename')
                        <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
